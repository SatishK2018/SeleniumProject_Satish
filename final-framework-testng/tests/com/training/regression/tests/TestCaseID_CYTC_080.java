...
public class TestCaseID_CYTC_080 {
	...
	******/	
	...
	@Test (dataProvider = "MemberPayment_excel-inputs_TC_080", dataProviderClass = MemberPaymentDataProvider.class)
	public void testCase_ID_CYTC_080(String memberLogin) throws InterruptedException {
		...
		actualResult = driver.switchTo().alert().getText().substring(0,18).trim();
		expectedResult = properties.getProperty("MemberPayment_ErrorMessg");
		assertEquals(actualResult, expectedResult);
		
		//Click Ok in the error message popup
